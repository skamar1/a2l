...
seo_title: "Τα Προγράμματά μας — ERP, CRM & Λογισμικό"
description: "Ολοκληρωμένες λύσεις ERP, CRM και hardware για κάθε επιχείρηση — από τις κορυφαίες εταιρείες λογισμικού της Ελλάδας."
slug: "programata"
layout: "programata"
...
products:
  ...
  - name: "Εφαρμογές Dynasoft"
    url: "/result-crm/"
    tag: "Dynasoft CRM"
    image: "/images/pexels-photomix-company-106344.webp"
    desc: "Διαχείριση πελατών, ευκαιριών πωλήσεων και αναφορών για ανάπτυξη εσόδων."

  - name: "Εφαρμογές Megasoft"
    url: "/megasoft/"
    tag: "Εμπορικές Εφαρμογές"
    image: "/images/pexels-yan-krukov-8867435.webp"
    desc: "Εμπορικές εφαρμογές για κάθε μέγεθος επιχείρησης — από απλή τιμολόγηση έως πλήρες ERP."

  - name: "Εφαρμογές Qorrect"
    url: "/plano/"
    tag: "ERP / Retail / Web"
