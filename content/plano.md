  ...
  - label: "RESTAURANT"
    ...
    modules:
      ...
      - icon: "🛵"
        ...
        features:
          - "Efood / Wolt integration"
          - "Παρακολούθηση διανομέα"
          - "Click & Collect"

cta_bottom:
  title: "Δείτε το Plano σε δράση"
  subtitle: "Ζητήστε δωρεάν demo και δείτε πώς το Plano μπορεί να βελτιώσει τη λειτουργία σας."
