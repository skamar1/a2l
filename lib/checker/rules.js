...
// 1.1.0 — προστέθηκε ο SEO-10 (εικονίδιο σελίδας). Ο βαθμός ενός site αλλάζει
// όταν αλλάζει το σύνολο των κανόνων, οπότε η έκδοση μπαίνει σε κάθε αναφορά:
// δύο reports με διαφορετική έκδοση δεν συγκρίνονται.
